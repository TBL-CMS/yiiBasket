...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'products-specification-form',
    ...
    <div class="widget-body">
      <div class="tab-content">     
      	...
      	<div class="tab-pane" id="validate_tab1">
	          	...
	          	<div class="controls">
	          		<?=$form->dropDownList($model,'required',array(0=>'No', 1=>'Yes'), array('class'=>'span7'));?>
	          		<span class="help-inline"><?php echo $form->error($model,'required'); ?>
</span>
	          	</div>
